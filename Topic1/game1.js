...
function setup() {
  ...
  background(0);
  board = loadImage("../Images/thumbnail_score.png");
  tut = loadImage("../Images/thumbnail_instructions.png");
...
function draw() {
  ...
  if (round < 8 && round > -1) {
    ...
    stroke(1);
    text("Time :        " + Math.floor(timerVal/60) + ":" + timerVal%60, 700, 60);
    text("Total Score : " + score, 700, 80);
  }

  if (round == -1) {
    image(tut,150,350, 500, 400);
    textAlign(CENTER);
